...
const AlertMessage: React.FC<AlertMessageProps> = ({
    ...
    return (
        <div className={`border-l-4 p-4 mb-5 ${typeClasses[type]}`}>
                ...
                {onDismiss && (
                    <div className="ml-auto pl-3">
                        <div className="-mx-1.5 -my-1.5">
                            <button
                                type="button"
                                className={`inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${type === 'success' ? 'focus:ring-green-500' :
